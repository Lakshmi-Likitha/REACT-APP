...
const Chat = () => {
    ...
    const handleKeyDown = (e) => {
        if (e.key === 'Enter' && !e.shiftKey) {
            e.preventDefault(); // Prevents default behavior of new line in text area
            handleSend(); // Calls handleSend function when Enter key is pressed
            setText("");  
        }
    };
        ...
        <div className='chat'>
            ...
            <div className="bottom">
                ...
                <input
                    ...
                    value={text}
                    onChange={e => setText(e.target.value)}
                    onKeyDown={handleKeyDown} // Add onKeyDown event to handle Enter key
                    disabled={isCurrentUserBlocked || isReceiverBlocked}
                />
                ...
                {showInfoMessage && setTimeout(() => setShowInfoMessage(false))}
                <button className="sendButton" onClick={handleSend} disabled={isCurrentUserBlocked || isReceiverBlocked}>Send</button>
            </div>
        </div>
    );
